...
sanad/
├── docker/
│   ├── nginx.conf          # Nginx config with WASM/ONNX support
...
│   │   ├── PatientDetail/  # Patient detail components
│   │   │   └── XrayAnalysisSection.tsx
│   │   ├── Sync/           # Sync status components
│   │   │   ├── SyncStatusBadge.tsx
│   │   │   └── ConflictBanner.tsx
│   │   └── Triage/         # Triage result components
│   ├── hooks/
│   │   ├── useXrayAnalysis.ts    # X-ray inference + CAM
│   │   ├── useHeatmapLoader.ts   # Load persisted heatmaps
...
│   ├── pages/
│   │   ├── LandingPage.tsx       # First-visit onboarding
│   │   ├── Home.tsx
│   │   ├── Assessment.tsx
│   │   ├── Queue.tsx
│   │   └── PatientDetail.tsx
...
│   │   └── blobUploader.ts       # Background blob upload
│   ├── store/
│   │   └── patientStore.ts       # Zustand + IndexedDB
│   └── types/
